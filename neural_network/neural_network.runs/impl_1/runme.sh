...
HD_PWD='C:/Users/maxsa/Downloads/Verilog/neural_network/neural_network.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_block.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cnn_block.tcl -notrace
