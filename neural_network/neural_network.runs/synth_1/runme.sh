...
HD_PWD='C:/Users/maxsa/Downloads/Verilog/neural_network/neural_network.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_block.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnn_block.tcl
